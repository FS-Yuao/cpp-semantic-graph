...
```markdown
---
doc_id: sensor-version-check-fix          # 全局唯一，kebab-case（必填）
...
- 变更文件：`update_manager.cpp`
- 审查日期：2026-08-04

## 发现问题

### [P0] <问题标题>
- 位置：`update_manager.cpp:402`
- 依据：...
- 影响：...
- 建议：...
...
```markdown
<!-- 对的 -->
关联任务见 [GNSS 版本校验修复](task/sensor_activate_version_check_fix.md)

<!-- 错的：纯文本，解析器不保证抓取 -->
关联任务：task/sensor_activate_version_check_fix.md
```
...
```markdown
<!-- 对的 -->
修复 `SensorUpdate::TryStart` 方法，调用 `ConfirmVersion` 刷新版本。
