...
**日期**: 2026-06-25
**审查对象**: `drive-vendor/ap/workspace/app/example_update_service/_tools/cpp_semantic_graph`
...
- 9 个工具的 docstring 示例从 `FirmwareUpdate/DeviceAdapter/PerformUpdate/QueryBootChain` 改为通用占位 `MyClass/doWork/getValue` 等。
