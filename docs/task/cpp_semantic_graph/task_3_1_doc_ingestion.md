...
```json
{
  ...
  "extra_info": {
    ...
    "section_level": 2,
    "heading": "FirmwareUpdate 升级流程设计",
    "content_preview": "FirmwareUpdate 继承 DeviceAdapter，实现 SoC 固件升级...",
    "content_hash": "sha256:abc123...",
    "tags": ["架构设计", "FirmwareUpdate"],
    "word_count": 350
  }
}
```
...
doc_dirs:
  - "docs/"
  - "drive-vendor/ap/workspace/app/example_update_service/docs/"
