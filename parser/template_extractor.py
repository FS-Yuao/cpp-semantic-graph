...
class TemplateExtractor:
    ...
    def extract_template_specializations(
        ...
        for cursor in tu_cursor.walk_preorder():
            ...
            # 如 "UpdateServiceInterfaceProxy" 而非 "ThreadDrivenProxy"
    ...
    def _extract_template_name(name: str) -> str | None:
        ...
        如 "UpdateServiceInterfaceProxy" → 无法提取（不是模板特化）
        如 "ThreadDrivenProxy<UpdateServiceInterface>" → "ThreadDrivenProxy"
        """
        if "<" in name:
