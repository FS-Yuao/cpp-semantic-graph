...
用法:
    ...
    classes = q.search_class("FirmwareUpdate")
    inh = q.get_inheritance("DeviceAdapter", direction="down")
...
def _extract_class_name(namespace: str) -> str | None:
    ...
    example_ns::FirmwareUpdate → FirmwareUpdate
    example_ns → None（命名空间本身不是类）
    """
