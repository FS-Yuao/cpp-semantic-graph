...
SOURCE_ROOT = "<PROJECT_SRC>/src"
INCLUDE_ROOT = "<PROJECT_SRC>/include"
...
TEST_CASES = [
    ...
    {"name": "NotifyProgress", "ns": "update::DeviceAdapter", "file": "base_device_update.h",
     "kind": "callers", "desc": "外设更新进度通知"},
    {"name": "FileExists", "ns": "update::FileHandler", "file": "file_handler.h",
     "kind": "callers", "desc": "文件存在检查"},
    # 继承
    {"name": "UpdateServiceClient", "ns": "", "file": "service/update_service_client.h",
     "kind": "inheritance", "desc": "OTA 服务客户端基类"},
    {"name": "FirmwareUpdate", "ns": "update", "file": "chip_update.h",
     "kind": "inheritance", "desc": "SoC 升级（继承 DeviceAdapter）"},
    # overrides（虚函数重写）：SwitchUpdate::TryPrepare 重写 DeviceAdapter::TryPrepare
    {"name": "TryPrepare", "ns": "update::SwitchUpdate", "file": "device_update/switch/switch_update.cpp",
