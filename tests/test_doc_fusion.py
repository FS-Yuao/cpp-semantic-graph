...
def test_doc_to_code():
    ...
    expected = [
        ("OTA_COMPLETE_FLOW.md", "PerformUpdate", True),
        ("OTA_COMPLETE_FLOW.md", "DeviceAdapter", True),
        ("OTA_COMPLETE_FLOW.md", "FirmwareUpdate", True),
        ("OTA_COMPLETE_FLOW.md", "ExecuteDriveUpdate", True),
        ("AB_PARTITION_SWITCH_DESIGN.md", "QueryBootChain", True),
        ("ARCHITECTURE.md", "UpdateManager", True),
        ("ARCHITECTURE.md", "DeviceAdapter", True),
    ]
...
def test_code_to_doc():
    ...
    cases = [
        ("FirmwareUpdate", "class", "应关联 OTA 流程/架构/错误处理等文档"),
        ("UpdateManager", "class", "应关联架构/初始化/状态机等文档"),
        ("PerformUpdate", "function", "应关联升级流程文档"),
        ("QueryBootChain", "class", "应关联 A/B 分区切换文档"),
