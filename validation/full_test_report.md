...
| 工具 | 查询 | 结果数 | 耗时 | 结果 |
|------|------|--------|------|------|
| search_class | DeviceAdapter | 1 | 0.4ms | ✅ |
| search_function | PerformUpdate | 6 | 0.7ms | ✅ |
| get_inheritance | DeviceAdapter down depth=1 | 4 | 1.3ms | ✅ |
| get_callers | PerformUpdate | 2 | 1.9ms | ✅ |
| get_callees | PerformUpdate (FirmwareUpdate) | 26 | 11.1ms | ✅ |
| get_overrides | PerformUpdate (DeviceAdapter) | 4 | 1.3ms | ✅ |
| get_file_symbols | chip_update.h | 1 | 0.6ms | ✅ |
| traverse_graph | FirmwareUpdate depth=2 | 50 | 20.1ms | ✅ |
