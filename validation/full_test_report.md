...
| 工具 | 查询 | 结果数 | 耗时 | 结果 |
|------|------|--------|------|------|
| search_class | DeviceAdapter | 1 | 0.2ms | ✅ |
| search_function | PerformUpdate | 6 | 0.3ms | ✅ |
| get_inheritance | DeviceAdapter down depth=1 | 4 | 0.8ms | ✅ |
| get_callers | PerformUpdate | 2 | 1.2ms | ✅ |
| get_callees | PerformUpdate (FirmwareUpdate) | 36 | 6.7ms | ✅ |
| get_overrides | PerformUpdate (DeviceAdapter) | 4 | 0.7ms | ✅ |
| get_file_symbols | chip_update.h | 1 | 0.4ms | ✅ |
| traverse_graph | FirmwareUpdate depth=2 | 50 | 7.6ms | ✅ |
